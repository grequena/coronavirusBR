...
### Observações por **continente** em `r as.character.POSIXt(max(coronavirus$date), format = "%d/%m/%Y")`
...
### Confirmados, recuperados e mortes em números absolutos
...
### Confirmados, recuperados e mortes **considerando o tamanho da população**
...
### Observações por **país** em `r as.character.POSIXt(max(coronavirus$date), format = "%d/%m/%Y")`
...
### Observações por **país na América do Sul** em `r as.character.POSIXt(max(coronavirus$date), format = "%d/%m/%Y")`
