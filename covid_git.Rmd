...
confirmed_colorTT <- rgb(20, 120, 190, maxColorValue = 255, alpha = 35)
death_colorTT     <- rgb(220, 40, 40,  maxColorValue = 255, alpha = 35)
recovered_colorTT <- rgb(10, 120, 10,  maxColorValue = 255, alpha = 35)
# - Use %>% directly
`%>%` <- magrittr::`%>%` 
