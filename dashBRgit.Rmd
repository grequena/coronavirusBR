...
#------------------ Parameters ------------------
# set colors
confirmed_colorBR <- rgb(30, 150, 180, maxColorValue = 255)
death_colorBR <- rgb(220, 40, 40, maxColorValue = 255, alpha = 180)
active_colorBR <- rgb(255,110,0, maxColorValue = 255, alpha = 200)
recovered_colorBR <- rgb(10, 120, 10, maxColorValue = 255, alpha = 180)
